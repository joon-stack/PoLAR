...
class Args:
    ...
    """Model to evaluate. Use 'polar' for a PoLAR latent VLA checkpoint; omit for random actions."""

    ckpt_path: str = ""
    """Path to the PoLAR Hugging Face VLA checkpoint directory."""

    action_decoder_path: str = ""
    """Path to the downstream action decoder checkpoint."""
...
def main():
    ...
    try:
        ...
        if args.model is None:
            pass
        elif args.model == "polar":
            from policies.polar import PoLARBridgeInference
            model = PoLARBridgeInference(
            ...
            raise ValueError(f"Unsupported model={args.model!r}; expected 'polar' or omitted random actions.")
