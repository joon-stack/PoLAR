...
class HFCausalLLMBackbone(LLMBackbone, ABC):
    def __init__(
        ...
        if use_flash_attention_2 and not _flash_attention_2_available():
            overwatch.warning("FlashAttention2 requested but flash_attn is not installed; falling back to default attention.")
