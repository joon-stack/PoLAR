...
class HFConvertConfig:
    ...
    llm_tokenizer_path: Union[str, Path] = '/path/to/llama2-7b-hf'       # Local path or HF Hub ID for the base LLM tokenizer

    action_vocab_size: int = 32                                         # Number of PoLAR action token IDs
    latent_action_token_len: int = 5                                    # Number of latent action tokens generated at inference
