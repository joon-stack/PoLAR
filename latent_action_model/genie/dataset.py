...
class LightningDataset(LightningDataModule):
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        return DataLoader(
            ...
            prefetch_factor=int(os.environ.get("POLAR_LAM_PREFETCH_FACTOR", "2")) if self.num_workers > 0 else None,
        )
...
class LightningOpenX(LightningDataset):
    ...
    def __init__(
        ...
        self.num_workers = int(os.environ.get("POLAR_LAM_NUM_WORKERS", "0"))
